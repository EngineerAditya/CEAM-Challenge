              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-500 text-sm md:text-base leading-relaxed">
                    Through this challenge we wish to attract the best minds in the field of autonomous vehicles and provide them with a platform to showcase their talent and innovation.
                  </p>
                </div>
                <div className="space-y-4">
                  <h4 className="font-mono text-xs text-white uppercase tracking-wider">The Collaboration</h4>
                  <p className="text-gray-500 text-sm md:text-base leading-relaxed">
                    A joint initiative by the <span className="text-white border-b border-[rgb(235,107,38)]/30">CEAM Research Lab</span> (MIT Bengaluru's autonomous vehicle research centre), the Department of ECE, Harman Automotive and ArtPark IISc.
                  </p>
                </div>
              </div>
            </motion.div>
